...
EXEC InsertMovieIfNotExists N'Mist of the Noir', 'Noir', 'David Fincher', 2025, 10, '/movie-images/shadows_in_the_fog.webp', 'https://example.com/trailer7', 'In a city veiled by fog, a detective unravels a mystery entangled in the shadows of crime and corruption.', 1, 110, @tmp, NULL;
EXEC InsertMovieIfNotExists N'The Enchanted Forest', 'Animated', 'Hayao Miyazaki', 2022, 9, '/movie-images/whispering_woods.webp', 'https://example.com/trailer8', 'A young girl discovers a magical forest where talking animals teach her about friendship', 1, 210, @tmp, NULL;
GO