...
EXEC InsertMovieIfNotExists N'Parisian Love Rhapsody', 'Romance/Comedy', 'Luc Besson', 2023, 8, '/app/movie-images/a_romantic_comedy_movie_poster_set_in_paris.webp', 'https://example.com/trailer1', 'In the heart of Paris, two lovers find each other through comedic misunderstandings, with the Eiffel Tower witnessing their blossoming romance.', 1, 120, @tmp, NULL;
EXEC InsertMovieIfNotExists N'Echoes of the Asylum', 'Horror', 'Guillermo Del Toro', 2022, 7, '/app/movie-images/asylum_shadows.webp', 'https://example.com/trailer2', 'An investigative journalist uncovers chilling secrets within the walls of an abandoned asylum, where the past haunts the present.', 1, 105, @tmp, NULL;
EXEC InsertMovieIfNotExists N'The Dragon Crest', 'Fantasy/Adventure', 'Peter Jackson', 2025, 9, '/app/movie-images/dragons_peak.webp', 'https://example.com/trailer3', 'A band of heroes embarks on a quest to find the Dragon Crest, battling through mystical lands shadowed by a legendary beast.', 1, 130, @tmp, NULL;
EXEC InsertMovieIfNotExists N'Stars of Eternity', 'Sci-Fi', 'Ridley Scott', 2024, 5, '/app/movie-images/galactic_requiem.webp', 'https://example.com/trailer4', 'In the vastness of space, a rebel fleet battles against a cosmic empire, with the fate of the universe hanging in the balance.', 1, 140, @tmp, NULL;
EXEC InsertMovieIfNotExists N'Invasion: Earth', 'Sci-Fi/Action', 'Michael Bay', 2023, 7, '/app/movie-images/invasion_battle.webp', 'https://example.com/trailer5', 'When Earth faces an alien threat, it''s up to a ragtag team of soldiers and scientists to defend our home against the impossible.', 1, 115, @tmp, NULL;
